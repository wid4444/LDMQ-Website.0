...
function Bio() {
  return (
    <div id='bio' className='max-w-[1040px] m-auto md:pl-20 p-4 pb-30 py-16 relative flex-column items-center justify-center h-auto w-full '>
        ...
        <div>
        <p className='my-2 2xl:text-xl xsm:text-md font-bold text-stone-500 dark:text-emerald-50'>Hi there! I'm Leobardo, although most folks know me as Danny.</p>
        <p className='my-2 2xl:text-xl xsm:text-md font-bold text-stone-500 dark:text-emerald-50'>Back in 2022, I made the exciting decision to dive into the world of coding and web development through Tech Elevator. Since then, I've had the incredible opportunity to craft software solutions for diverse clients, including non-profits, artists, and small corporation.</p>
        <p className='my-2 2xl:text-xl xsm:text-md font-bold text-stone-500 dark:text-emerald-50'>These days, my primary focus revolves around creating user-friendly interfaces for our valued customers at Tech Impact. I'm particularly drawn to the intersection of design and engineering, where I strive to build software that not only looks good but also performs seamlessly behind the scenes.</p>
        <p className='my-2 2xl:text-xl xsm:text-md font-bold text-stone-500 dark:text-emerald-50'> My tech stack includes a blend of frontend and backend technologies like React.js, Vue.js, Spring Boot, and UI/UX design tools such as Figma and Adobe XD. Leveraging languages like Java, HTML, CSS, and JavaScript, alongside frameworks like Bootstrap and Tailwind, and libraries for visualizations like Mapbox and Recharts.</p>
        <p className='my-2 2xl:text-xl xsm:text-md font-bold text-stone-500 dark:text-emerald-50'>When I'm not at my computer, you'll often find me in my woodworking workshop, enjoying quality time with my wife and our furry companion Lilly, tackling various projects around the house, or watching anime.</p>
