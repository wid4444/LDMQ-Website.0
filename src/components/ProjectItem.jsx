...
const ProjectItem = ({img, title, link, github, skills, libraries, paper }) => {
  return (
   
    <div className='relative flex items-center justify-center h-auto w-full  hover:shadow-md hover:shadow-gray-400 rounded-2xl group hover:bg-gradient-to-r from-cyan-950 to-violet-950 '>
...
<div className='flex items-center justify-center space-x-4'>
            ...
            <a href={paper} target="_blank" rel="noopener noreferrer">
                <p className='text-center p-3 rounded-lg bg-white text-gray-700 font-bold cursor-pointer text-lg'>Paper</p>
            </a>
            )}
            </div>
